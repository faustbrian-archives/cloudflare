...
class VirtualDns extends AbstractAPI
{
    ...
    {
        return $this->client->get("organizations/{$organizationIdentifier}/virtual_dns", $parameters);
    }
    ...
    {
        return $this->client->get("organizations/{$organizationIdentifier}/virtual_dns/{$identifier}", $parameters);
    }

    public function delete(array $parameters = []): HttpResponse
    {
        return $this->client->delete("organizations/{$organizationIdentifier}/virtual_dns/{$identifier}", $parameters);
    }
