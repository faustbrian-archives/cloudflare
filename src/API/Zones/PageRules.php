...
class PageRules extends AbstractAPI
{
    ...
    {
        return $this->client->get("zones/{$zoneIdentifier}/page_rules/{$identifier}", $parameters);
    }
    ...
    {
        return $this->client->delete("zones/{$zoneIdentifier}/page_rules/{$identifier}", $parameters);
    }
}
